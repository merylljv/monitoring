...
def assign_schedule(key, year, month, recompute=False):
    ...
    # Shift of admin
    shiftdf, shift_count = assign_admin_mc_shifts(shiftdf, shift_count, admin_list, curr_start, next_start, fieldwork, satPM)
